...
namespace TreeDesigner.Editor
{
    public class BaseNodeView : Node, IGroupable
    {
        ...
        public BaseNodeView(BaseNode node, BaseTreeWindow treeWindow, string path) : base(path)
        {
            ...
            m_Node.OnUpdateCallback = Update;
        ...
        {
            //int nodeIndex = m_Node.Owner.Nodes.FindIndex(i => i == m_Node);
            //if (nodeIndex == -1)
            //    return;
        ...
        protected override void ToggleCollapse()
        {
            ...
            {
                base.ToggleCollapse();
                m_Node.ApplyModify("Expand Node", () =>
                {
        ...
        {
            var script = TreeDesignerUtility.GetNodeScript(m_Node.GetType());
            if (script != null)

...
namespace TreeDesigner.Editor
{
    public class NodePanelView : GraphElement
    {
        ...
        public NodePanelView()
        {
            ...
            m_DragLine = this.Q("dragLine");
            m_DragLine.AddManipulator(new DragLineManipulator((f) => 
            {
                style.width = Mathf.Max(style.width.value.value + f, style.minWidth.value.value);
            }));
        ...
        void AddField(string name, VisualElement field)
        {
